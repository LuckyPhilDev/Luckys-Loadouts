...
Pick existing Blizzard talent loadouts and get reminders when your content changes.
...
Install through CurseForge, or copy `Luckys_Loadouts` into your World of Warcraft `_retail_\Interface\AddOns` folder. Shared suite support is bundled in packaged releases.
